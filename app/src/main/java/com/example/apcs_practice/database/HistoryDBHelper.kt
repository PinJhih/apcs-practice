...
class HistoryDBHelper(
    ...
    override fun onCreate(db: SQLiteDatabase) {
        db.execSQL("CREATE TABLE histories (id text PRIMARY KEY,date text NOT NULL,title text NOT NULL,session integer NOT NULL, myAnswer text NOT NULL, correctRate text NOT NULL)")
    }
